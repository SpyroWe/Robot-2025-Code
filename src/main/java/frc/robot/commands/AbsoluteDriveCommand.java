...
public class AbsoluteDriveCommand extends Command
{
   ...
   */
  public  AbsoluteDriveCommand(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
  ...
  public void execute()
  {
    double headingX = 0;
    double headingY = 0;
    SmartDashboard.putNumber("2640TST0", headingX);
    ...
    SmartDashboard.putNumber("headY", headingX);
    SmartDashboard.putNumber("headY", headingY);
